...
/*  property alias softKeyIconList: softkeys.softkeyIconList
    ...
    property string lbImage: "qrc:/images/left_arrow.png"
  ...
  // Window Title
    Rectangle {
              ...
              Text{
                  id: titletext
                  anchors.centerIn: titlebarpag
                  text: "System Menu Page 2"
                  font.pixelSize: 16
                  color: "white"
              }
    }
   ...
   */
    ...
    Rectangle {
        id: menuView
        //anchors.fill: parent
        width: 330; height: 7*parent.height*hfrac - 10
        color: "steelblue"
        anchors.right: rightarrowB.left
        anchors.rightMargin: 10
        anchors.left: leftarrowB.right
        anchors.leftMargin: 10
        anchors.top: titlebarpag.bottom
        anchors.topMargin: 5
        //x: 15; y: 5
            ...
            if (!event.isAutoRepeat) {
                switch (event.key) {   // How about next screen if last index in ListModel conatainer?
                    ...
                    case Qt.Key_F1:
                        ...
                        sstatscreen.source ="qrc:/qml//MainScreen.qml"
                        event.accepted = true
                        }
                        break;
                    case Qt.Key_F2:
                        {
                        // Back To System Status Main Screen
                        console.log( "Back To System Status Main Menu Screen" )
                        //sstatscreen.source ="qrc:/qml/GarfunkelSystemStatusIdleScreen.qml"
                        sstatscreen.goBack();
