...
//% NextPageView.qml
//%
//% NextPageScreen.qml Is an Instance of this View
//%
...
Rectangle {
    ...
    property string arrowImage: "qrc:/images/BlueArrow.png"  //% Arrow to indicate directions  //right_arrow.png"
    ...
    Connections
          {
        	...
        	onGoBack: {
                    menuLoader.source = "qrc:/qml//MainScreen.qml";
