//%
//% SystemStatusMainView.qml 
//%
//% SSMainScreen.qml Is an Instance of this View
//%
...
Rectangle {
    ...
    property alias source: ssmenuLoader.source
    property alias item: ssmenuLoader.item
    ...
    Loader {
            ...
            onSourceChanged: {
                if (source == "") {
                    ssmenuView.visible = true
                    ssmenuView.focus = true
                    ssmainView.visible = true
                    ssmainView.focus = true
                } else {
                     ssmenuLoader.focus = true
                }
            }
            onLoaded: ssmenuView.visible = false
        }

        Connections {
            target:  ssmenuLoader.item
            onGoBack: {
                    ssmenuLoader.source = ""
    ...
    Connections
          {
        	...
        	onGoBack: {
                        ...
                        menuLoader.source = ""; //menuLoader.source = "qrc:/qml//MainScreen.qml";
